Shader /*ase_name*/ "Hidden/Universal/2D Unlit Extra Pass" /*end*/
{
	Properties
	{
		/*ase_props*/
		...
		Pass
		{
			...
			VertexOutput vert( VertexInput v /*ase_vert_input*/ )
			{
				...
				float3 vertexValue = /*ase_vert_out:Vertex Offset;Float3;3;-1;_VertexP*/defaultVertexValue/*end*/;
					...
					v.vertex.xyz += vertexValue;
				#endif
				v.normal = /*ase_vert_out:Vertex Normal;Float3;4;-1;_VNormalP*/v.normal/*end*/;
				v.tangent.xyz = /*ase_vert_out:Vertex Tangent;Float3;5;-1;_VTangentP*/v.tangent.xyz/*end*/;
			...
			half4 frag( VertexOutput IN /*ase_frag_input*/ ) : SV_Target
			{
				...
				/*ase_frag_code:IN=VertexOutput*/
				float4 Color = /*ase_frag_out:Color;Float4;1;-1;_ColorP*/float4( 1, 1, 1, 1 )/*end*/;
